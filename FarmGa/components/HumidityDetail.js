...
const HumidityDetail = ({name,level,safetyLevel, onPress}) => {
    return (
    ...
    //               <MaterialCommunityIcon name='water-plus-outline' size={40} color="#575454" />
    //               <Text style={{borderWidth:1, width:'94%', textAlign:'center', borderRadius:10, fontSize:12,backgroundColor:"#5B449E"}}>Humidity</Text>
    //               <Pressable 
    //                   onPress={onPress}
    //                   style={sensor.button}>
    //                   <Text >Chi tiết</Text>
    ...
    //               <Progress.Circle color={"green"} thickness={7} borderWidth={0} unfilledColor={"#F5E7E7"} fill={"#DBD1D0"} progress={level/100} size={60} />
    ...
    <View style={sensor.container}>
        <View style={sensor.sensorContainer}>
             <MaterialCommunityIcon name='water-plus-outline' size={40} color="#575454" /> 
             <Text style={{marginLeft:15,color:"green",fontWeight:500, fontSize:22,  }}>I'm good</Text>
        </View>
        <View style={sensor.sensorContainer}>
             <Text style={{color:"#3b3232",fontWeight:500, fontSize:18,  }}>HUMIDITY </Text>
             <Text style={{color:"#3b3232",fontWeight:500, fontSize:18,  }}>{level}%  </Text>
             <Text style={{color:"grey",fontWeight:400, fontSize:14, marginLeft:'auto',marginRight:5, }}>18-25  </Text>
             <Pressable
                onPress={onPress}>
